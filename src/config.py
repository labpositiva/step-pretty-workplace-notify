...
WERCKER_PRETTY_WORKPLACE_COMMUNITY = os.environ.get(
    'WERCKER_PRETTY_WORKPLACE_COMMUNITY'
)
...
WERCKER_PRETTY_WORKPLACE_USER = os.environ.get(
    'WERCKER_PRETTY_WORKPLACE_USER'
)
...
WERCKER_GIT_DOMAIN = os.environ.get('WERCKER_GIT_DOMAIN', 'github.com')
